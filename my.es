...
function MY:CreateSP500(r) {
  ...
  ES:SetName(SP500GDP_STDEV, 'SP500GDP_STDEV');
  SP500GDP_L = SP500GDP_AVG - 2 * SP500GDP_STDEV;
  ES:SetName(SP500GDP_L, 'SP500GDP_L');
  SP500GDP_U = SP500GDP_AVG + 2 * SP500GDP_STDEV;
  ES:SetName(SP500GDP_U, 'SP500GDP_U');
  :GPut('SP500GDP_AVG', SP500GDP_AVG);
  :GPut('SP500GDP_STDEV', SP500GDP_STDEV);
  :GPut('SP500GDP_L', SP500GDP_L);
  :GPut('SP500GDP_U', SP500GDP_U);
